...
mod_wsgi-express setup-server --working-directory nameserver --url-alias /static static --application-type module nameserver.wsgi --server-root /tmp --port 8085 --mount-point /sne/nameserver_atlas
